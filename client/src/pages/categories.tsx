...
export default function Categories() {
  ...
  const { categories, isLoadingCategories } = useNiceFramework();
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage NICE Framework categories</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isLoadingCategories ? "Loading..." : `${filteredCategories.length} Categories`}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <DataTable
