...
export default function Tasks() {
  ...
  const { tasks, isLoadingTasks } = useNiceFramework();
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage NICE Framework task statements</p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isLoadingTasks ? "Loading..." : `${filteredTasks.length} Tasks`}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <DataTable
